...
<head>
  ...
  <title>SCC | Report Floor 5</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Report Floor F0005</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="dashboard">Dashboard</a></li>
              <li class="breadcrumb-item active">Report Floor F0005</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
...
{{--            </div>--}}
            <!-- /.card-body -->
                  <div class="card-header">
                      <h3 class="card-title">Rooms in Floor F0005</h3>
                      ...
                      <table id="example1" class="table table-bordered table-striped">
                          ...
                          <tr>
                              ...
                              <td class="project-actions text-left">
                                  <a class="btn btn-primary btn-sm" href="report-room">
