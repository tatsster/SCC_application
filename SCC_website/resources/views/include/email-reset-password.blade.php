                            ...
                            <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td>
                                        ...
                                        <br>
                                        <h3>@lang("Hi"),</h3>
                                        <h3>@lang("This is your temporary password:")</h3>
                                        <h3><b style="color: #dc3545">{{$new_password}}</b></h3>
...
{{--                                                        <tbody>--}}
{{--                                                        <tr>--}}
{{--                                                            <td> <a href="http://localhost:8000/get-your-form?form_id={{{ $form_id  }}}" style="font-size: 20px; background-color: #2BA519; border: 0px; pointer-events: none">KIỂM TRA MÃ ĐƠN</a> </td>--}}
{{--                                                        </tr>--}}
{{--                                                        </tbody>--}}
{{--                                                    </table>--}}
{{--                                                </td>--}}
